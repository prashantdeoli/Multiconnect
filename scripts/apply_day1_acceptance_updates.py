...
def require_config_only_mode(args: argparse.Namespace) -> None:
    ...
    if any(
        ...
        raise ValueError("--from-config cannot be combined with explicit --audio-* or --ui-* overrides.")

    if args.write_config:
        raise ValueError("--from-config cannot be combined with --write-config.")
