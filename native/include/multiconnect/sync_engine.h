...
class SyncEngine {
  public:
    ...
    // Strict lookup variant that returns false when deviceId is not registered.
    bool tryDeviceSnapshot(const std::string& deviceId, DeviceSnapshot* outSnapshot) const;
