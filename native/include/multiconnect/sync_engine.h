...
struct SessionMetrics {
    std::size_t registeredDevices = 0;
    std::size_t totalPullCalls = 0;
    std::size_t totalPulledSamples = 0;
    std::size_t totalDriftCorrectionsApplied = 0;
};
