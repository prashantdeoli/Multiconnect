...
int main() {
    ...
    multiconnect::DeviceSnapshot strictSonySnapshot{};
    assert(engine.tryDeviceSnapshot("sony", &strictSonySnapshot));
    assert(strictSonySnapshot.deviceId == "sony");
    assert(strictSonySnapshot.state.offsetSamples == 0);
    assert(strictSonySnapshot.metrics.pullCalls == 0);
    ...
    multiconnect::DeviceSnapshot strictMissingSnapshot{};
    assert(!engine.tryDeviceSnapshot("missing", &strictMissingSnapshot));
    assert(!engine.tryDeviceSnapshot("tribit", nullptr));
