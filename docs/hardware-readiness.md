...
Generate a ready-to-fill three-run checklist (commands included):

```bash
python scripts/generate_phase1_hardware_plan.py --date 2026-02-18 --initials qa
```

This writes `docs/phase1-hardware-test-plan.md` with scenario commands that map to the baseline hardware inventory.
