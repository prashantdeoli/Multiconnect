...
4. Track Phase-1 readiness with `scripts/validate_phase1_readiness.py` (use `--enforce` for milestone gates).
5. Publish `docs/phase1-status.md` from current evidence for weekly gate review.
