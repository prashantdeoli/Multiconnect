...
- `scripts/apply_day1_acceptance_updates.py` — updates Day-1 baseline acceptance statuses/evidence for physical audio + UI responsiveness checks.
...
Then run `./scripts/run_native_checks.sh` to regenerate `docs/project-blockers.md`.
