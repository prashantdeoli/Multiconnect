...
Session topology can be introspected via `deviceCount`, lexicographically sorted `registeredDeviceIds`, and snapshot helpers (`deviceSnapshot`, `allDeviceSnapshots`) for stable live routing diagnostics.
